...
//        });
        ...
        Button searchEditText = findViewById(R.id.btnLogout);
        searchEditText.setOnClickListener(v -> startActivity(new Intent(Profile_User.this, Login_userActivity.class)));
