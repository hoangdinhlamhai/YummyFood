                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Thu nhập</p>
                            <h4 class="mb-0">1.000.000 VND</h4>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Đơn chưa xác nhận</p>
                            <h4 class="mb-0">10</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Số bàn còn trống</p>
                            <h4 class="mb-0">3</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
